...
const Hero = () => {
	return (
		<section
			id="home"
			className="min-h-screen flex items-center justify-center  bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
		>
			<div className="container mx-auto px-6 py-20 md:py-32">
				<div className="flex container flex-col md:flex-row items-center gap-12 ">
					<motion.div
						initial={{ opacity: 0, x: -50 }}
						animate={{ opacity: 1, x: 0 }}
						transition={{ duration: 0.8 }}
						className="md:w-1/2 order-2 md:order-1  ms-12"
					>
						<motion.div
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
						...
						<div className="flex flex-wrap gap-4 ">
							<motion.a
								href="public/cv.pdf" // Make sure this file exists in your `public` folder
								target="_blank"
					...
					>
						<div className="relative">
							<div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl relative ">
								<img
									src={yourImage}
									alt="Zaryab Dogar"
							...
							>
								<div className="sm:h-12 sm:w-12 h-8 w-8 bg-white dark:bg-white rounded-full flex items-center justify-center overflow-hidden ">
									<img
										src={jsLogo}
										alt="Next.js Logo"
										className="w-8 h-8 object-contain"
